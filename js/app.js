 ...
 */
    ...
    (() => {
        ...
        if (inputMasksPhone.length) flsModules.inputMasksPhone = Inputmask({
        ...
        function initSliders() {
            if (document.querySelector(".specialists__slider")) new core(".specialists__slider", {
            ...
            if (document.querySelector("#directionSliderOne")) new core("#directionSliderOne", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                pagination: {
            ...
            if (document.querySelector("#directionSliderTwo")) new core("#directionSliderTwo", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                pagination: {
            ...
            if (document.querySelector("#directionSliderThree")) new core("#directionSliderThree", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                pagination: {
            ...
            if (document.querySelector("#directionSliderFour")) new core("#directionSliderFour", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                pagination: {
        ...
        let initSeven = false;
        let initEight = false;
        let examplesSliderOne;
        let examplesSliderTwo;
        let examplesSliderThree;
        let examplesSliderFour;
        let reviewsSliderOne;
        let reviewsSliderTwo;
        let reviewsSliderThree;
        let reviewsSliderFour;
        function exampleOne() {
            if (window.innerWidth <= 480) {
                if (!initOne) {
                    initOne = true;
                    examplesSliderOne = new core("#examplesSliderOne", {
                        modules: [ Navigation, Pagination ],
                        slidesPerView: 1,
                        spaceBetween: 30,
                        pagination: {
        ...
        function exampleTwo() {
            if (window.innerWidth <= 480) {
                if (!initTwo) {
                    initTwo = true;
                    examplesSliderTwo = new core("#examplesSliderTwo", {
                        modules: [ Navigation, Pagination ],
                        slidesPerView: 1,
                        spaceBetween: 30,
                        pagination: {
        ...
        function exampleThree() {
            if (window.innerWidth <= 480) {
                if (!initThree) {
                    initThree = true;
                    examplesSliderThree = new core("#examplesSliderThree", {
                        modules: [ Navigation, Pagination ],
                        slidesPerView: 1,
                        spaceBetween: 30,
                        pagination: {
        ...
        function exampleFour() {
            if (window.innerWidth <= 480) {
                if (!initFour) {
                    initFour = true;
                    examplesSliderFour = new core("#examplesSliderFour", {
                        modules: [ Navigation, Pagination ],
                        slidesPerView: 1,
                        spaceBetween: 30,
                        pagination: {
        ...
        function reviewOne() {
            if (window.innerWidth <= 480) {
                if (!initFive) {
                    initFive = true;
                    reviewsSliderOne = new core("#reviewsSliderOne", {
                        modules: [ Navigation, Pagination ],
                        slidesPerView: 1,
                        spaceBetween: 30,
                        pagination: {
        ...
        function reviewTwo() {
            if (window.innerWidth <= 480) {
                if (!initSix) {
                    initSix = true;
                    reviewsSliderTwo = new core("#reviewsSliderTwo", {
                        modules: [ Navigation, Pagination ],
                        slidesPerView: 1,
                        spaceBetween: 30,
                        pagination: {
        ...
        function reviewThree() {
            if (window.innerWidth <= 480) {
                if (!initSeven) {
                    initSeven = true;
                    reviewsSliderThree = new core("#reviewsSliderThree", {
                        modules: [ Navigation, Pagination ],
                        slidesPerView: 1,
                        spaceBetween: 30,
                        pagination: {
        ...
        function reviewFour() {
            if (window.innerWidth <= 480) {
                if (!initEight) {
                    initEight = true;
                    reviewsSliderFour = new core("#reviewsSliderFour", {
                        modules: [ Navigation, Pagination ],
                        slidesPerView: 1,
                        spaceBetween: 30,
                        pagination: {
        ...
        reviewThree();
        reviewFour();
        window.addEventListener("resize", exampleOne);
        window.addEventListener("resize", exampleTwo);
        window.addEventListener("resize", exampleThree);
        window.addEventListener("resize", exampleFour);
        window.addEventListener("resize", reviewOne);
        window.addEventListener("resize", reviewTwo);
        window.addEventListener("resize", reviewThree);
        window.addEventListener("resize", reviewFour);
...
***************************************************************************** */
        ...
        const options = document.getElementsByClassName("form-calc__option-item");
        for (const option of options) option.addEventListener("click", (function handleClick() {
